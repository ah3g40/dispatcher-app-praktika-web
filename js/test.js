$(document).ready(function() {
    ...
    function displayFlights(flights) {    
        ...
        const coords = $('<li>', {
            class: 'flight-info-list-item',
            id: 'coords',
            text: "Координаты: "+flights.latitude.toFixed(6)+", "+flights.longitude.toFixed(6)
        });
        const distanceBetweenAirports = $('<li>', {
            class: 'flight-info-list-item',
            text: "Расстояние между аэропортами: "+flights.distanceBetweenAirportsKm+" км ("+flights.distanceBetweenAirportsM+" м)"
            ...
            ymaps.ready(function () {
                ...
                function movePlacemark(flights) {
                    if (plane && myMap) {
                        ...
                        //----- Динамич. обновл-е данных ---------
                        $('#flight-speed').text("Скорость: "+flights.speed+" kn");
                        $('#coords').text("Координаты: "+flights.latitude.toFixed(6)+", "+flights.longitude.toFixed(6));
