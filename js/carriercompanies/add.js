$(document).ready(function () {
    ...
    //---------------------------------- CARRIERCOMPANIES_POST ----------------------------
    
    $("[name='carrierCompanyForm']").one('submit', async function (event) { 
        ...
        try {
            ...
            $.ajax({
                type: "POST",
                url: urls.CarrierCompanies.Global,
                data: JSON.stringify(data),
                contentType: "application/json",
                success: function (response) {
                    console.log("Данные отправлены на " + urls.CarrierCompanies.Global);
                },
            ...
            $.ajax({
                type: "POST",
                url: urls.CarrierCompanies.Local,
                data: JSON.stringify(data),
                contentType: "application/json",
                success: function (response) {
                    console.log("Данные отправлены на " + urls.CarrierCompanies.Local);
                },
                error: function (error) {
